              ...
              <Offcanvas.Body className="d-flex justify-content-center">
                <ListGroup>
                    ...
                    <Accordion.Item eventKey="0" style={{ border: "none" }}>
                      ...
                      >
                        <ListGroup.Item
                          ...
                          href="#module1"
                          className={`list-item ${
                            activeItem === "module1" ? "list-item-active" : ""
                          }`}
                          style={{
                        ...
                        <ListGroup.Item
                          ...
                          href="#module2"
                          className={`list-item ${
                            activeItem === "module2" ? "list-item-active" : ""
                          }`}
                          style={{
                            backgroundColor: "white",
                            color: "black",
                        ...
                        <ListGroup.Item
                          ...
                          href="#module3"
                          className={`list-item ${
                            activeItem === "module3" ? "list-item-active" : ""
                          }`}
                          style={{
                            backgroundColor: "white",
                            color: "black",
                        ...
                        <ListGroup.Item
                          ...
                          href="#module4"
                          className={`list-item ${
                            activeItem === "module4" ? "list-item-active" : ""
                          }`}
                          style={{
                            backgroundColor: "white",
                            color: "black",
                        ...
                        <ListGroup.Item
                          ...
                          href="#module5"
                          className={`list-item ${
                            activeItem === "module5" ? "list-item-active" : ""
                          }`}
                          style={{
                            backgroundColor: "white",
                            color: "black",
                  ...
                  <ListGroup.Item
                    ...
                    href="#grades"
                    className={`list-item ${
                      activeItem === "grades" ? "list-item-active" : ""
                    }`}
                    style={{
                      backgroundColor: "white",
                      color: "black",
                  ...
                  <ListGroup.Item
                    ...
                    href="#massages"
                    className={`list-item ${
                      activeItem === "massages" ? "list-item-active" : ""
                    }`}
                    style={{
                      backgroundColor: "white",
                      color: "black",
                  ...
                  <ListGroup.Item
                    ...
                    href="#courseInfo"
                    className={`list-item ${
                      activeItem === "courseInfo" ? "list-item-active" : ""
                    }`}
                    style={{
                      backgroundColor: "white",
                      color: "black",
